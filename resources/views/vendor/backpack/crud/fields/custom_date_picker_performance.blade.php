...
@if ($crud->checkIfFieldIsFirstOfItsType($field, $fields))
    ...
    <script>
        ...
        function updateDatePickerDates() {
            var selectedOption = $('select[name="period_id"] option:selected');
            var start = selectedOption.attr('data-start');
            var end = selectedOption.attr('data-end');
            $('input[data-bs-datepicker]').datepicker('setStartDate', new Date(start));
            $('input[data-bs-datepicker]').datepicker('setEndDate', new Date(end));
        }
