...
@if ($crud->checkIfFieldIsFirstOfItsType($field, $fields))
	...
	@push('crud_fields_styles')
		...
		<link href="{{ secure_asset('vendor/backpack/colorbox/example2/colorbox.css') }}" rel="stylesheet" type="text/css" />
		<style>
	...
	@push('crud_fields_scripts')
		...
		<script src="{{ secure_asset('vendor/backpack/colorbox/jquery.colorbox-min.js') }}"></script>
	@endpush
